...
class InputValidator:
    ...
    def validate_path(cls, path: str) -> str:
        ...
        # Expand user home directory. Note: we deliberately do NOT call
        # .resolve() here - this validator is also used for remote (SSH/SFTP)
        # paths, and resolving would incorrectly normalize/interpret them
        # against the local filesystem and current working directory.
