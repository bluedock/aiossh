...
This repository contains different versions of the AIOSSH library.

## Versions

- [aiossh-1.1.0](./aiossh-1.1.0) — stable release
- [aiossh-1.0.0](./aiossh-1.0.0) — previous release

Refer to the corresponding folder to use each version.
